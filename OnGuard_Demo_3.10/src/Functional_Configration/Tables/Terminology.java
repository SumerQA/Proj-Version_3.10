...
public class Terminology {
  ...
  @Parameters({"Locale"})
  @Test(priority=33)
  public void Verify_Dunning_letters_Terminology_List_value(String Locale) throws Exception {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Terminology_Page tp_page = new Terminology_Page(driver);
	  tp_page.Terminology_list("6", "t_terminology_list_table");
	  String myque=getTerminology_Type(Locale, 6, 1);
	  String status = db.getQuery(myque);
  ...
  @Parameters({"Locale"})
  @Test(priority=36)
  public void Verify_Menu_items_Terminology_List_value(String Locale) throws Exception {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Terminology_Page tp_page = new Terminology_Page(driver);
	  tp_page.Terminology_list("10000", "t_terminology_list_table");
	  String myque=getTerminology_Type(Locale, 10000, 51);
	  String status = db.getQuery(myque);
	  boolean list= tp_page.Terminology_Value(status, "t_terminology_value_table");
	  if(list){
		  String value =status;
  ...
  @Parameters({"Locale"})
  @Test(priority=37)
  public void Verify_Notes_maintenance_definitions_Terminology_List_value(String Locale) throws Exception {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Terminology_Page tp_page = new Terminology_Page(driver);
  ...
  public void Verify_Reports_Terminology_List_value() throws IOException, InterruptedException {
	  ...
	  boolean list= tp_page.Terminology_Value("Dashboards.Dashboard", "t_terminology_value_table");
	  if(list){
		  String value ="Dashboards.Dashboard";
		  tp_page.Change_icon();
		  Thread.sleep(1500);
		  tp_page.English_En(value);
		  tp_page.English_US(value);
  ...
  @Parameters({"Locale"})
  @Test(priority=45)
  public void Verify_Standard_solutions_Terminology_List_value(String Locale) throws Exception {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Terminology_Page tp_page = new Terminology_Page(driver);
  ...
  @Parameters({"Locale"})
  @Test(priority=46)
  public void Verify_Standard_text_Terminology_List_value(String Locale) throws Exception {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Terminology_Page tp_page = new Terminology_Page(driver);
  ...
  @Parameters({"Locale"})
  @Test(priority=47)
  public void Verify_Status_Maintenance_Terminology_List_value(String Locale) throws Exception {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  Terminology_Page tp_page = new Terminology_Page(driver);
