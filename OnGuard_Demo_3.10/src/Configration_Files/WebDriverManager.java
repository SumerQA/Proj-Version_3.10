...
public class WebDriverManager {
	...
	public static WebDriver startDriver(String browser, String URL)
		...
		if (browser.equals("FF")) {
			...
			// URL("http://192.168.0.151:4444/wd/hub"),capabilities);
		...
		if (browser.equals("CH")) {
			...
			System.setProperty("webdriver.chrome.driver","D:/Selenium projects/Workspace/OnGuard_Demo_3.10/drivers/chromedriver.exe");
		...
		if (browser.equals("IE")) {
			try {
				...
				System.setProperty("webdriver.ie.driver","D:/Selenium projects/Workspace/OnGuard_Demo_3.10/rivers/IEDriverServer.exe");
