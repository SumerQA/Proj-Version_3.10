...
import appMan_Pages.API_Client_Page;
...
public class API_client {
	...
	ReadXclData rddata=new ReadXclData();
	 ...
	 @Test(priority=1)
	  public void Open_API_client_Page() throws Exception {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  API_Client_Page api_page = PageFactory.initElements(driver, API_Client_Page.class);
		  Reporter.log("________________________ API Client Page_____________________________ ");
		  api_page.Goto_ApiClient_page();
	  }
	  @Test(priority=2)
	  ...
	  public void Update_API_client_User() throws Exception  {
		  ...
		  api_page.IP_address("192.168.0.151");
		  api_page.Token_Expiry("15");
		  api_page.Generate_token_Button();
		  api_page.Notification();
