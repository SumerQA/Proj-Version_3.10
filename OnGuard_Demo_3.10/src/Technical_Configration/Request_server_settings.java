...
public class Request_server_settings {
	...
	ReadXclData rddata=new ReadXclData();
	 ...
	 @Test(priority=1)
	  ...
	  @Test(priority=19)
	  public void Validate_WebService_URL_inputfield() throws IOException, InterruptedException, InvalidInputException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  events eve = new events(driver);
		  Reporter.log("Select Email Settings from DDlist");
	  ...
	  @Test(priority=20)
	  public void Validate_SMTP_Server_Name_inputfield() throws IOException, InterruptedException, InvalidInputException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  events eve = new events(driver);
	  ...
	  @Test(priority=21)
	  public void Validate_IMAP_Server_Name_inputfield() throws IOException, InterruptedException, InvalidInputException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  events eve = new events(driver);
		  if(driver.findElement(By.xpath(c.getElementName("RSS_SMTP_Server_name"))).isEnabled()){
	  ...
	  @Test(priority=22)
	  public void Validate_Mail_Server_Username_inputfield() throws IOException, InterruptedException, InvalidInputException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  events eve = new events(driver);
	  ...
	  @Test(priority=23)
	  public void Validate_Mail_Server_Password_inputfield() throws IOException, InterruptedException, InvalidInputException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  events eve = new events(driver);
	  ...
	  @Test(priority=24)
	  public void Validate_Mail_Server_Confirm_Password_inputfield() throws IOException, InterruptedException, InvalidInputException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  events eve = new events(driver);
	  ...
	  @Test(priority=25)
	  public void Validate_SMTP_port_inputfield() throws IOException, InterruptedException, InvalidInputException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  events eve = new events(driver);
	  ...
	  @Test(priority=26)
	  public void Validate_IMAP_port_inputfield() throws IOException, InterruptedException, InvalidInputException {
		  WebDriver driver=WebDriverManager.getDriverInstance();
		  Request_Server_Settings_page RSS_page= PageFactory.initElements(driver, Request_Server_Settings_page.class);
		  events eve = new events(driver);
	  ...
	  public void SetUp_valid_Request_server_settings_Configration() throws IOException, InterruptedException {
		  ...
		  Reporter.log("Enter Mail Server Password - ");
		  RSS_page.Enter_Mail_Server_Password("beschuit1");
		  Reporter.log("Enter Mail Server Password for confirmation - ");
		  RSS_page.Enter_MailServer_Confirm_Password("beschuit1");
		  Reporter.log("Enter SMTP Port - ");
