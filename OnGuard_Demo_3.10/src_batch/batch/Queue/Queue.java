...
@Test(priority=3)
  ...
  @Parameters({"Locale"})
  @Test(priority=11)
  public void Verify_Send_According_to_Batch_rules_For_Single_Action(String Locale) throws Exception {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  queue_page qp = new queue_page(driver);
	  events eve = new events(driver);
	  qp.send();
	  ...
	  Thread.sleep(1000);
	  qp.Search_and_SelectColumn("Q_table", status);        // Click on First row in Grid
	  Thread.sleep(1000);
	  qp.send();
	  Thread.sleep(2000);
  ...
  @Parameters({"Locale"})
  @Test(priority=12)
  public void Verify_Send_According_to_Batch_rules_For_Multiple_Action(String Locale) throws Exception {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  queue_page qp = new queue_page(driver);
	  events eve = new events(driver);
	  String myque=eve.getLocale(Locale, "Queued");
	  String status = db.getQuery(myque);
	  qp.Search_and_SelectMultiple_Column("Q_table", status); 
	  Thread.sleep(1000);
	  qp.send();
	  Thread.sleep(2000);
  ...
  @Parameters({"Locale"})
  @Test(priority=13)
  public void Delete_Failed_Action_From_Queue(String Locale) throws Exception {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  queue_page qp = new queue_page(driver);
	  events eve = new events(driver);
	  Thread.sleep(3000);
	  ...
	  String status = db.getQuery(myque);
	  qp.Search_and_SelectColumn("Q_table", status);
	  try {
		  qp.Delete();
	} catch (Exception e) {
	  ...
	  String status1 = db.getQuery(myque1);
	  qp.Search_and_SelectColumn("Q_table", status1);
	  Thread.sleep(1000);
	  qp.Delete();
	  Thread.sleep(1000);
  ...
  @Parameters({"Locale"})
  @Test(priority=14)
  public void Delete_Multiple_Action_From_Queue(String Locale) throws Exception {
	  WebDriver driver=WebDriverManager.getDriverInstance();
	  queue_page qp = new queue_page(driver);
	  events eve = new events(driver);
	  String myque=eve.getLocale(Locale, "failed");
	  ...
	  String myque1=eve.getLocale(Locale, "failed");
	  String status1 = db.getQuery(myque1);
	  qp.Search_and_SelectMultiple_Column("Q_table", status1);
	  Thread.sleep(1000);
	  qp.Delete();
	  Thread.sleep(1000);
	  qp.Reason_Notification("No Comments please");
