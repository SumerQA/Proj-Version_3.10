...
@Test(priority=2)
  ...
  public void Link_Batch_rule_to_MediaType_Email() throws InterruptedException, IOException {
	  ...
	  ES_page.UserName("edwin");
	  Thread.sleep(500);
	  ES_page.Password("kim");
	  ES_page.Check_Password("kim");
	  Thread.sleep(500);
	  ES_page.Email_Address("emailbatch@yopmail.com");
	  Thread.sleep(500);
	  ES_page.Server_Name_SMTP("smtp.gmail.com");
	  Thread.sleep(500);
	  ES_page.port_SMTP("45");
	  Thread.sleep(500);
